            ...
            if (data != null && data.Count > 0)
            {
                ...
                foreach(var q in data)
                {
                   //if (q.LeadTime == 35)
                    if (q.LeadTime == 30)
                    {
                        Count35 = data.Count(d => d.LeadTime == 30);
                        Count35Ok = data.Count(d => d.DateDiff >= 25 && d.LeadTime == 30);
                        Count35NotOk = data.Count(d => d.DateDiff < 25 && d.LeadTime == 30);
                        //if (Count35Ok > 0)
                        //{
                ...
                dataTable.Rows.Add(null, "Status OK", null, "Selisih Tgl Penerimaan RO dengan Tgl Shipment >= 25 hari", null, null, null, null, null, null, null);
                dataTable.Rows.Add(null, "Persentase Status OK", null, $"{Count35Ok}/{Count35} X 100% = {Percent35Ok}", null, null, null, null, null, null, null);
                dataTable.Rows.Add(null, "Status NOT OK", null, "Selisih Tgl Penerimaan RO dengan Tgl Shipment < 25 hari", null, null, null, null, null, null, null);
