    ...
    public class LatestAvailableBudgetReportFacade : ILatestAvailableBudgetReportFacade
    {
        ...
        public Tuple<MemoryStream, string> GenerateExcel(string filter = "{}")
        {
            ...
            if (data != null && data.Count > 0)
            {
                ...
                dataTable.Rows.Add(null, "KESIAPAN BUDGET DENGAN LEAD TIME 30 HARI", null, null, null, null, null, null, null, null, null, null, null);
                dataTable.Rows.Add(null, "Status OK", null, "Selisih Tgl Kesiapan Budget dengan Tgl Shipment >= 30 hari", null, null, null, null, null, null, null, null, null);
                ...
                dataTable.Rows.Add(null, "Status NOT OK", null, "Selisih Tgl Kesiapan Budget dengan Tgl Shipment < 30 hari", null, null, null, null, null, null, null, null, null);
